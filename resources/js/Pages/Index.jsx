    ...
    return (
        <> 
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                <Link href={route('courses.index')} className="group inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-[#030712]" role="alert">
                    <span className="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Nuevo</span> <span className="text-sm font-medium">Cursos academicos!</span> 
                    <svg className="group-hover:translate-x-1 duration-150 ml-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                </Link>
                <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Invierte en mejorar tu potencial</h1>
                <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400"> El potencial de un curso es posible con Minires </p>
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    <a href="#" className="group inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                        Más
                        <svg className="group-hover:translate-x-2 duration-150 ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                    </a>
                    <Link href={route('courses.index')} className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-900 dark:focus:ring-gray-900">
                        <svg className="mr-2 -ml-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 6a2 2 0 012-2h6a2 2 0 012 2v8a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"></path></svg>
                        Ver cursos
                    </Link>  
                </div>
                <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
                    <span className="font-semibold text-gray-400 uppercase"> Tambien en </span>
                    <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
                        ...
                        <a href="#" className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400">
                            <svg className="h-11 fill-gray-500 hover:fill-gray-400" viewBox="0 0 1091.9 308.5" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M1014.9 130c3.9 11.1 7.7 22.1 11.6 33.1 3.8 11.1 7.6 22.2 12 34.9l22.4-68.1h31L1037.8 267h-31.4l14.9-38-41.1-99h34.7z"/>
                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
                    <dl class="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">{users}</dt>
                            <dd class="text-gray-500 dark:text-gray-400 font-semibold">Usuarios</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">0</dt>
                            <dd class="font-semibold text-gray-500 dark:text-gray-400">Profesores</dd>
                        </div>
                        <div class="flex flex-col items-center justify-center">
                            <dt class="mb-2 text-3xl md:text-4xl font-extrabold">0</dt>
                            <dd class="font-semibold text-gray-500 dark:text-gray-400">Organizaciones</dd>
                        </div>
                    </dl>
                </div>
            </section>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <div className="max-w-screen-md mb-8 lg:mb-16">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"> Diseñado para aprender y mejorar el aprendizaje </h2>
                        <p className="text-gray-500 sm:text-xl dark:text-gray-400"> Innova, enseña y aprende de la mejor manera  </p>
                    </div>
                    <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                        <div>
                            ...
                            <p className="text-gray-500 dark:text-gray-400"> Planealo, amplialo y realizalo, colabora con otros y arma una comunidad del aprendizaje moderno </p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <p className="text-gray-500 dark:text-gray-400"> Protejemos tu persona y tus enseñanzas, demuestra y enseña lo que gustes </p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Negocio simple</h3>
                            <p className="text-gray-500 dark:text-gray-400"> Simplifica tareas, cursos, categorias y tags con nuestros sistemas </p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Finanza</h3>
                            <p className="text-gray-500 dark:text-gray-400"> Con las operaciones de presupuesto y cursos de paga tendras tu propia manera de ponerle costos a tu producto, sin porcentaje, todo es tuyo </p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Diseño de empresas</h3>
                            <p className="text-gray-500 dark:text-gray-400"> Diseña y colabora con otras compañias y empresas, el objetivo de enseñar y demostrar no tiene limites aqui </p>
                        </div>
                        <div>
                            <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                            ...
                            <h3 className="mb-2 text-xl font-bold dark:text-white">Operaciones</h3>
                            <p className="text-gray-500 dark:text-gray-400">Opera tus cursos de paga o gratuitos de la mejor manera, incluso si no eres profesor </p>
                        </div>
                    </div>
                </div>
                </section>
